 ...
 */
public class AndroidMMFF94BasedParameterSetReader {

    private final ILoggingTool  LOG            = LoggingToolFactory
            .createLoggingTool(AndroidMMFF94BasedParameterSetReader.class);
     ...
     */
    public AndroidMMFF94BasedParameterSetReader() {
